#ifndef CtreCanMap_H_
#define CtreCanMap_H_
...
{
public:
	CtreCanMap(uint8_t deviceNumber);
    ~CtreCanMap();
...
protected:
	...
	CTR_Code GetRx(uint32_t arbId, uint8_t * dataBytes, uint32_t timeoutMs, bool allowStale);
