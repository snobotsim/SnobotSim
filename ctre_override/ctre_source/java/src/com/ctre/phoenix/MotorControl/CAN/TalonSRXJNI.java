...
public class TalonSRXJNI extends CTREJNIWrapper {
  // Motion Profile status bits
   ...
   public static String CTR_SigNotUpdated_MESSAGE = "CTRE CAN Signal Not Updated";
	 ...
	 final public static int CTR_RxTimeout = 1;
	 final public static int CTR_TxTimeout = 2;
	 final public static int CTR_InvalidParamValue = 3;
	 final public static int CTR_UnexpectedArbId = 4;
	 final public static int CTR_TxFailed = 5;
	 final public static int CTR_SigNotUpdated = 6;
	 final public static int ERR_CANSessionMux_InvalidBuffer = -44086;
	 final public static int ERR_CANSessionMux_MessageNotFound = -44087;
	 final public static int WARN_CANSessionMux_NoToken = 44087;
	 final public static int ERR_CANSessionMux_NotAllowed = -44088;
   ...
   */
   ...
   public static native long new_TalonSRX(int deviceNumber, int controlPeriodMs,
                                            int enablePeriodMs);

   public static native long new_TalonSRX(int deviceNumber, int controlPeriodMs);

   public static native long new_TalonSRX(int deviceNumber);

   public static native void delete_TalonSRX(long handle);
  ...
  public static native void Set(long handle, double value);
   ...
   public static native int GetClearPosOnIdx(long handle);
  
   public static native int GetClearPosOnLimR(long handle);
  
   public static native int GetClearPosOnLimF(long handle);
   ...
   public static native int GetMotMagActTraj_Velocity(long handle);
   
   public static native int GetMotMagActTraj_Position(long handle);
   ...
   public static native void SetCurrentLimEnable(long handle, boolean enable);
   
   public static native void SetDataPortOutputPeriodMs(long handle, int param);
   
   public static native void SetDataPortOutputEnable(long handle, int idx, boolean enable);
   
   public static native void SetDataPortOutputOnTimeMs(long handle, int idx, int OnTimeMs);
