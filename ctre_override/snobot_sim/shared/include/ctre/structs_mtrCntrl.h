...
typedef struct _TALON_Control_5_General_10ms_t {
	...
	unsigned ReservedZero:3;
	unsigned CurrentConditionMode_2:2;
...
typedef struct _TALON_Status_4_AinTempVbat_100ms_t {
	...
	unsigned BatteryV:8;
	unsigned reserved:3;
	unsigned ClearPosOnLimIdx:1;
	unsigned ClearPosOnLimR:1;
	unsigned ClearPosOnLimF:1;
	unsigned VelDiv4:1;
	unsigned PosDiv8:1;
...
typedef struct _TALON_Status_10_MotMag_100ms_t {
	unsigned ActTraj_VelocityH:8;
	unsigned ActTraj_VelocityL:8;
	unsigned ActTraj_PositionH:8;
	unsigned ActTraj_PositionM:8;
	unsigned ActTraj_PositionL:8;
	unsigned ActTraj_TimeToTargetH:8;
	unsigned ActTraj_TimeToTargetL:8;
	unsigned ActTraj_DistToTarget:8;
} TALON_Status_10_MotMag_100ms_t ;

typedef struct _TALON_Status_11_DebugGadgeteer_t {
	unsigned GadgeteerUart_Type:8;
	unsigned GadgeteerUart_State:4;
	unsigned GadgeteerUart_ChirpRxCnt:4;
	unsigned GadgeteerUart_BitrateH:8;
	unsigned GadgeteerUart_BitrateL:8;
	unsigned GadgeteerUart_DiagStatus:8;
	unsigned GadgeteerUart_TxCnt:8;
	unsigned GadgeteerUart_RetryTotalCnt:8;
	unsigned GadgeteerUart_ResetCnt:8;
} TALON_Status_11_DebugGadgeteer_t ;
