...
Java_edu_wpi_first_wpilibj_hal_AnalogJNI_initializeAnalogInputPort(JNIEnv *env, jclass, jint id)
{
    ...
    CheckStatusRange(env, status, 0, HAL_GetNumAnalogInputs(), hal::getPortHandleChannel((HAL_PortHandle) id));
    return (jint) analog;
}
...
Java_edu_wpi_first_wpilibj_hal_AnalogJNI_freeAnalogInputPort(JNIEnv *env, jclass, jint id)
{
 ...
 */
JNIEXPORT jint JNICALL
Java_edu_wpi_first_wpilibj_hal_AnalogJNI_initializeAnalogOutputPort(JNIEnv *env, jclass, jint id)
{
    ANALOGJNI_LOG(logDEBUG) << "Port Handle = " << (HAL_PortHandle) id;
    int32_t status = 0;
    ...
    ANALOGJNI_LOG(logDEBUG) << "Status = " << status;
    ANALOGJNI_LOG(logDEBUG) << "Analog Handle = " << analog;
    CheckStatusRange(env, status, 0, HAL_GetNumAnalogOutputs(), hal::getPortHandleChannel((HAL_PortHandle) id));
    return (jlong) analog;
}
 ...
 */
JNIEXPORT void JNICALL
Java_edu_wpi_first_wpilibj_hal_AnalogJNI_freeAnalogOutputPort(JNIEnv *env, jclass, jint id)
{
...
Java_edu_wpi_first_wpilibj_hal_AnalogJNI_checkAnalogModule(JNIEnv *, jclass, jbyte value)
{
 ...
 */
JNIEXPORT jboolean JNICALL
Java_edu_wpi_first_wpilibj_hal_AnalogJNI_checkAnalogInputChannel(JNIEnv *, jclass, jint value)
{
 ...
 */
JNIEXPORT jboolean JNICALL
Java_edu_wpi_first_wpilibj_hal_AnalogJNI_checkAnalogOutputChannel(JNIEnv *, jclass, jint value)
{
    // ANALOGJNI_LOG(logDEBUG) << "Channel = " << value;
 ...
 * Signature: (ID)V
 */
JNIEXPORT void JNICALL Java_edu_wpi_first_wpilibj_hal_AnalogJNI_setAnalogOutput(JNIEnv *env, jclass, jint id, jdouble voltage)
{
...
Java_edu_wpi_first_wpilibj_hal_AnalogJNI_getAnalogOutput(JNIEnv *env, jclass, jint id)
{
    int32_t status = 0;
 ...
 */
JNIEXPORT void JNICALL
Java_edu_wpi_first_wpilibj_hal_AnalogJNI_setAnalogSampleRate(JNIEnv *env, jclass, jdouble value)
{
 ...
 */
JNIEXPORT jdouble JNICALL
Java_edu_wpi_first_wpilibj_hal_AnalogJNI_getAnalogSampleRate(JNIEnv *env, jclass)
{
    int32_t status = 0;
 ...
 */
JNIEXPORT void JNICALL
Java_edu_wpi_first_wpilibj_hal_AnalogJNI_setAnalogAverageBits(JNIEnv *env, jclass, jint id, jint value)
{
 ...
 */
JNIEXPORT jint JNICALL
Java_edu_wpi_first_wpilibj_hal_AnalogJNI_getAnalogAverageBits(JNIEnv *env, jclass, jint id)
{
    ANALOGJNI_LOG(logDEBUG) << "Analog Handle = " << (HAL_AnalogInputHandle) id;
    int32_t status = 0;
 ...
 */
JNIEXPORT void JNICALL
Java_edu_wpi_first_wpilibj_hal_AnalogJNI_setAnalogOversampleBits(JNIEnv *env, jclass, jint id, jint value)
{
 ...
 */
JNIEXPORT jint JNICALL
Java_edu_wpi_first_wpilibj_hal_AnalogJNI_getAnalogOversampleBits(JNIEnv *env, jclass, jint id)
{
    ANALOGJNI_LOG(logDEBUG) << "Analog Handle = " << (HAL_AnalogInputHandle) id;
    int32_t status = 0;
...
Java_edu_wpi_first_wpilibj_hal_AnalogJNI_getAnalogValue(JNIEnv *env, jclass, jint id)
{
 ...
 */
JNIEXPORT jint JNICALL
Java_edu_wpi_first_wpilibj_hal_AnalogJNI_getAnalogAverageValue(JNIEnv *env, jclass, jint id)
{
    ANALOGJNI_LOG(logDEBUG) << "Analog Handle = " << (HAL_AnalogInputHandle) id;
    int32_t status = 0;
 ...
 */
JNIEXPORT jint JNICALL
Java_edu_wpi_first_wpilibj_hal_AnalogJNI_getAnalogVoltsToValue(JNIEnv *env, jclass, jint id, jdouble voltageValue)
{
    ANALOGJNI_LOG(logDEBUG) << "Analog Handle = " << (HAL_AnalogInputHandle) id;
 ...
 */
JNIEXPORT jdouble JNICALL
Java_edu_wpi_first_wpilibj_hal_AnalogJNI_getAnalogVoltage(JNIEnv *env, jclass, jint id)
{
    // ANALOGJNI_LOG(logDEBUG) << "Analog Handle = " << (void*)id;
    int32_t status = 0;
 ...
 */
JNIEXPORT jdouble JNICALL
Java_edu_wpi_first_wpilibj_hal_AnalogJNI_getAnalogAverageVoltage(JNIEnv *env, jclass, jint id)
{
    ANALOGJNI_LOG(logDEBUG) << "Analog Handle = " << (HAL_AnalogInputHandle) id;
    int32_t status = 0;
 ...
 */
JNIEXPORT jint JNICALL
Java_edu_wpi_first_wpilibj_hal_AnalogJNI_getAnalogLSBWeight(JNIEnv *env, jclass, jint id)
{
    ANALOGJNI_LOG(logDEBUG) << "Analog Handle = " << (HAL_AnalogInputHandle) id;
    int32_t status = 0;
 ...
 * Signature: (I)I
 */
JNIEXPORT jint JNICALL Java_edu_wpi_first_wpilibj_hal_AnalogJNI_getAnalogOffset(JNIEnv *env, jclass, jint id)
{
    ANALOGJNI_LOG(logDEBUG) << "Analog Handle = " << (HAL_AnalogInputHandle) id;
    int32_t status = 0;
 ...
 */
JNIEXPORT jboolean JNICALL
Java_edu_wpi_first_wpilibj_hal_AnalogJNI_isAccumulatorChannel(JNIEnv *env, jclass, jint id)
{
 ...
 * Signature: (I)V
 */
JNIEXPORT void JNICALL Java_edu_wpi_first_wpilibj_hal_AnalogJNI_initAccumulator(JNIEnv *env, jclass, jint id)
{
    ANALOGJNI_LOG(logDEBUG) << "Analog Handle = " << (HAL_AnalogInputHandle) id;
    int32_t status = 0;
 ...
 */
JNIEXPORT void JNICALL
Java_edu_wpi_first_wpilibj_hal_AnalogJNI_resetAccumulator(JNIEnv *env, jclass, jint id)
{
    ANALOGJNI_LOG(logDEBUG) << "Analog Handle = " << (HAL_AnalogInputHandle) id;
    int32_t status = 0;
 ...
 */
JNIEXPORT void JNICALL
Java_edu_wpi_first_wpilibj_hal_AnalogJNI_setAccumulatorCenter(JNIEnv *env, jclass, jint id, jint center)
{
    ANALOGJNI_LOG(logDEBUG) << "Analog Handle = " << (HAL_AnalogInputHandle) id;
    int32_t status = 0;
 ...
 */
JNIEXPORT void JNICALL
Java_edu_wpi_first_wpilibj_hal_AnalogJNI_setAccumulatorDeadband(JNIEnv *env, jclass, jint id, jint deadband)
{
    ANALOGJNI_LOG(logDEBUG) << "Analog Handle = " << (HAL_AnalogInputHandle) id;
    int32_t status = 0;
...
Java_edu_wpi_first_wpilibj_hal_AnalogJNI_getAccumulatorValue(JNIEnv *env, jclass, jint id)
{
    ANALOGJNI_LOG(logDEBUG) << "Analog Handle = " << (HAL_AnalogInputHandle) id;
    int32_t status = 0;
 ...
 */
JNIEXPORT jint JNICALL
Java_edu_wpi_first_wpilibj_hal_AnalogJNI_getAccumulatorCount(JNIEnv *env, jclass, jint id)
{
    ANALOGJNI_LOG(logDEBUG) << "Analog Handle = " << (HAL_AnalogInputHandle) id;
    int32_t status = 0;
 ...
 */
JNIEXPORT void JNICALL
Java_edu_wpi_first_wpilibj_hal_AnalogJNI_getAccumulatorOutput(JNIEnv *env, jclass, jint id, jobject value, jobject count)
{
    ANALOGJNI_LOG(logDEBUG) << "Analog Handle = " << (HAL_AnalogInputHandle) id;
    int32_t status = 0;
 ...
 */
JNIEXPORT jint JNICALL
Java_edu_wpi_first_wpilibj_hal_AnalogJNI_initializeAnalogTrigger(JNIEnv *env, jclass, jint id, jobject index)
{
    ANALOGJNI_LOG(logDEBUG) << "Port Handle = " << (HAL_AnalogInputHandle) id;
    jint *indexHandle = (jint *) env->GetDirectBufferAddress(index);
    ANALOGJNI_LOG(logDEBUG) << "Index Ptr = " << indexHandle;
    int32_t status = 0;
    HAL_AnalogTriggerHandle analogTrigger = HAL_InitializeAnalogTrigger((HAL_AnalogInputHandle) id, (int32_t *) indexHandle, &status);
    ANALOGJNI_LOG(logDEBUG) << "Status = " << status;
 ...
 */
JNIEXPORT void JNICALL
Java_edu_wpi_first_wpilibj_hal_AnalogJNI_cleanAnalogTrigger(JNIEnv *env, jclass, jint id)
{
 ...
 */
JNIEXPORT void JNICALL
Java_edu_wpi_first_wpilibj_hal_AnalogJNI_setAnalogTriggerLimitsRaw(JNIEnv *env, jclass, jint id, jint lower, jint upper)
{
    ANALOGJNI_LOG(logDEBUG) << "Analog Trigger Handle = " << (HAL_AnalogTriggerHandle) id;
    int32_t status = 0;
 ...
 */
JNIEXPORT void JNICALL
Java_edu_wpi_first_wpilibj_hal_AnalogJNI_setAnalogTriggerLimitsVoltage(JNIEnv *env, jclass, jint id, jdouble lower, jdouble upper)
{
    ANALOGJNI_LOG(logDEBUG) << "Analog Trigger Handle = " << (HAL_AnalogTriggerHandle) id;
    int32_t status = 0;
 ...
 */
JNIEXPORT void JNICALL
Java_edu_wpi_first_wpilibj_hal_AnalogJNI_setAnalogTriggerAveraged(JNIEnv *env, jclass, jint id, jboolean averaged)
{
    ANALOGJNI_LOG(logDEBUG) << "Analog Trigger Handle = " << (HAL_AnalogTriggerHandle) id;
    int32_t status = 0;
 ...
 */
JNIEXPORT void JNICALL
Java_edu_wpi_first_wpilibj_hal_AnalogJNI_setAnalogTriggerFiltered(JNIEnv *env, jclass, jint id, jboolean filtered)
{
    ANALOGJNI_LOG(logDEBUG) << "Analog Trigger Handle = " << (HAL_AnalogTriggerHandle) id;
    int32_t status = 0;
 ...
 */
JNIEXPORT jboolean JNICALL
Java_edu_wpi_first_wpilibj_hal_AnalogJNI_getAnalogTriggerInWindow(JNIEnv *env, jclass, jint id)
{
    ANALOGJNI_LOG(logDEBUG) << "Analog Trigger Handle = " << (HAL_AnalogTriggerHandle) id;
    int32_t status = 0;
 ...
 */
JNIEXPORT jboolean JNICALL
Java_edu_wpi_first_wpilibj_hal_AnalogJNI_getAnalogTriggerTriggerState(JNIEnv *env, jclass, jint id)
{
    ANALOGJNI_LOG(logDEBUG) << "Analog Trigger Handle = " << (HAL_AnalogTriggerHandle) id;
    int32_t status = 0;
 ...
 */
JNIEXPORT jboolean JNICALL
Java_edu_wpi_first_wpilibj_hal_AnalogJNI_getAnalogTriggerOutput(JNIEnv *env, jclass, jint id, jint type)
{
    ANALOGJNI_LOG(logDEBUG) << "Analog Trigger Handle = " << (HAL_AnalogTriggerHandle) id;
    int32_t status = 0;
    jboolean val = HAL_GetAnalogTriggerOutput((HAL_AnalogTriggerHandle) id, (HAL_AnalogTriggerType) type, &status);
    CheckStatus(env, status);
    return val;
}
