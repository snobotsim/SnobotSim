 ...
 * Signature: (B)V
 */
JNIEXPORT void JNICALL Java_edu_wpi_first_wpilibj_hal_I2CJNI_i2CInitialize(JNIEnv* env, jclass, jbyte value)
{
 ...
 */
JNIEXPORT jint JNICALL Java_edu_wpi_first_wpilibj_hal_I2CJNI_i2CTransaction(JNIEnv* env, jclass, jbyte port, jbyte address, jobject dataToSend, jbyte sendSize,
        jobject dataReceived, jbyte receiveSize)
{
    ...
    jint returnValue = HAL_TransactionI2C(port, address, dataToSendPtr, sendSize, dataReceivedPtr, receiveSize);
 ...
 */
JNIEXPORT jint JNICALL Java_edu_wpi_first_wpilibj_hal_I2CJNI_i2CWrite(JNIEnv* env, jclass, jbyte port, jbyte address, jobject dataToSend, jbyte sendSize)
{
 ...
 * Signature: (BBLjava/nio/ByteBuffer;B)I
 */
JNIEXPORT jint JNICALL Java_edu_wpi_first_wpilibj_hal_I2CJNI_i2CRead(JNIEnv* env, jclass, jbyte port, jbyte address, jobject dataReceived, jbyte receiveSize)
{
