...
Java_edu_wpi_first_wpilibj_hal_SerialPortJNI_serialInitializePort(JNIEnv* env, jclass, jbyte port)
{
 ...
 */
JNIEXPORT void JNICALL
Java_edu_wpi_first_wpilibj_hal_SerialPortJNI_serialSetBaudRate(JNIEnv* env, jclass, jbyte port, jint rate)
{
 ...
 */
JNIEXPORT void JNICALL
Java_edu_wpi_first_wpilibj_hal_SerialPortJNI_serialSetDataBits(JNIEnv* env, jclass, jbyte port, jbyte bits)
{
 ...
 */
JNIEXPORT void JNICALL
Java_edu_wpi_first_wpilibj_hal_SerialPortJNI_serialSetParity(JNIEnv* env, jclass, jbyte port, jbyte parity)
{
 ...
 */
JNIEXPORT void JNICALL
Java_edu_wpi_first_wpilibj_hal_SerialPortJNI_serialSetStopBits(JNIEnv* env, jclass, jbyte port, jbyte bits)
{
 ...
 */
JNIEXPORT void JNICALL
Java_edu_wpi_first_wpilibj_hal_SerialPortJNI_serialSetWriteMode(JNIEnv* env, jclass, jbyte port, jbyte mode)
{
 ...
 */
JNIEXPORT void JNICALL
Java_edu_wpi_first_wpilibj_hal_SerialPortJNI_serialSetFlowControl(JNIEnv* env, jclass, jbyte port, jbyte flow)
{
 ...
 */
JNIEXPORT void JNICALL
Java_edu_wpi_first_wpilibj_hal_SerialPortJNI_serialSetTimeout(JNIEnv* env, jclass, jbyte port, jdouble timeout)
{
 ...
 */
JNIEXPORT void JNICALL
Java_edu_wpi_first_wpilibj_hal_SerialPortJNI_serialEnableTermination(JNIEnv* env, jclass, jbyte port, jchar terminator)
{
 ...
 */
JNIEXPORT void JNICALL
Java_edu_wpi_first_wpilibj_hal_SerialPortJNI_serialDisableTermination(JNIEnv* env, jclass, jbyte port)
{
 ...
 */
JNIEXPORT void JNICALL
Java_edu_wpi_first_wpilibj_hal_SerialPortJNI_serialSetReadBufferSize(JNIEnv* env, jclass, jbyte port, jint size)
{
 ...
 */
JNIEXPORT void JNICALL
Java_edu_wpi_first_wpilibj_hal_SerialPortJNI_serialSetWriteBufferSize(JNIEnv* env, jclass, jbyte port, jint size)
{
...
Java_edu_wpi_first_wpilibj_hal_SerialPortJNI_serialGetBytesRecieved(JNIEnv* env, jclass, jbyte port)
{
 ...
 */
JNIEXPORT jint JNICALL Java_edu_wpi_first_wpilibj_hal_SerialPortJNI_serialRead(JNIEnv* env, jclass, jbyte port, jobject dataReceived, jint size)
{
    ...
    int32_t status = 0;
    jint retVal = HAL_ReadSerial(static_cast<HAL_SerialPort>(port), reinterpret_cast<char*>(dataReceivedPtr), size, &status);
 ...
 * Signature: (BLjava/nio/ByteBuffer;I)I
 */
JNIEXPORT jint JNICALL Java_edu_wpi_first_wpilibj_hal_SerialPortJNI_serialWrite(JNIEnv* env, jclass, jbyte port, jobject dataToSend, jint size)
{
    ...
    int32_t status = 0;
    jint retVal = HAL_WriteSerial(static_cast<HAL_SerialPort>(port), reinterpret_cast<char*>(dataToSendPtr), size, &status);
    SERIALJNI_LOG(logDEBUG) << "ReturnValue = " << retVal;
    SERIALJNI_LOG(logDEBUG) << "Status = " << status;
    CheckStatus(env, status);
    return retVal;
 ...
 * Signature: (B)V
 */
JNIEXPORT void JNICALL Java_edu_wpi_first_wpilibj_hal_SerialPortJNI_serialFlush(JNIEnv* env, jclass, jbyte port)
{
 ...
 * Signature: (B)V
 */
JNIEXPORT void JNICALL Java_edu_wpi_first_wpilibj_hal_SerialPortJNI_serialClear(JNIEnv* env, jclass, jbyte port)
{
 ...
 * Signature: (B)V
 */
JNIEXPORT void JNICALL Java_edu_wpi_first_wpilibj_hal_SerialPortJNI_serialClose(JNIEnv* env, jclass, jbyte port)
{
