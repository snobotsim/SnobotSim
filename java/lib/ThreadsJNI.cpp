 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_edu_wpi_first_wpilibj_hal_ThreadsJNI_getCurrentThreadPriority(JNIEnv *env, jclass)
{
 ...
 * Signature: ()Z
 */
JNIEXPORT jboolean JNICALL Java_edu_wpi_first_wpilibj_hal_ThreadsJNI_getCurrentThreadIsRealTime(JNIEnv *env, jclass)
{
 ...
 * Signature: (ZI)Z
 */
JNIEXPORT jboolean JNICALL Java_edu_wpi_first_wpilibj_hal_ThreadsJNI_setCurrentThreadPriority(JNIEnv *env, jclass, jboolean realTime, jint priority)
{
