...
extern "C" {
/*
 * Class:     com_snobot_simulator_jni_module_1wrapper_AnalogOutWrapperJni
 * Method:    isInitialized
 * Signature: (I)Z
 */
JNIEXPORT jboolean JNICALL
Java_com_snobot_simulator_jni_module_1wrapper_AnalogOutWrapperJni_isInitialized
...
Java_com_snobot_simulator_jni_module_1wrapper_AnalogOutWrapperJni_setName
...
Java_com_snobot_simulator_jni_module_1wrapper_AnalogOutWrapperJni_getName
 ...
 */
JNIEXPORT jboolean JNICALL
Java_com_snobot_simulator_jni_module_1wrapper_AnalogOutWrapperJni_getWantsHidden
 ...
 */
JNIEXPORT jboolean JNICALL
Java_com_snobot_simulator_jni_module_1wrapper_AnalogOutWrapperJni_createSimulator
  (JNIEnv* env, jclass, jint aHandle, jstring aType)
{
    return FactoryContainer::Get().GetAnalogOutFactory()->Create(aHandle, env->GetStringUTFChars(aType, NULL));
}
 ...
 */
JNIEXPORT void JNICALL
Java_com_snobot_simulator_jni_module_1wrapper_AnalogOutWrapperJni_removeSimluator
  (JNIEnv*, jclass, jint)
{
}
...
Java_com_snobot_simulator_jni_module_1wrapper_AnalogOutWrapperJni_getVoltage
  (JNIEnv* env, jclass, jint portHandle)
{
...
Java_com_snobot_simulator_jni_module_1wrapper_AnalogOutWrapperJni_getPortList
  (JNIEnv* env, jclass)
{
    const std::map<int, std::shared_ptr<IAnalogOutWrapper>>& analogWrappers = SensorActuatorRegistry::Get().GetIAnalogOutWrapperMap();

    jintArray output = env->NewIntArray(analogWrappers.size());

    jint values[30];

    std::map<int, std::shared_ptr<IAnalogOutWrapper>>::const_iterator iter = analogWrappers.begin();
