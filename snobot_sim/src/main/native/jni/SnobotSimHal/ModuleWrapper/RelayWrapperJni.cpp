...
extern "C" {
/*
 * Class:     com_snobot_simulator_jni_module_1wrapper_RelayWrapperJni
 * Method:    isInitialized
 * Signature: (I)Z
 */
JNIEXPORT jboolean JNICALL
Java_com_snobot_simulator_jni_module_1wrapper_RelayWrapperJni_isInitialized
...
Java_com_snobot_simulator_jni_module_1wrapper_RelayWrapperJni_setName
...
Java_com_snobot_simulator_jni_module_1wrapper_RelayWrapperJni_getName
 ...
 */
JNIEXPORT jboolean JNICALL
Java_com_snobot_simulator_jni_module_1wrapper_RelayWrapperJni_getWantsHidden
 ...
 */
JNIEXPORT jboolean JNICALL
Java_com_snobot_simulator_jni_module_1wrapper_RelayWrapperJni_createSimulator
 ...
 */
JNIEXPORT void JNICALL
Java_com_snobot_simulator_jni_module_1wrapper_RelayWrapperJni_removeSimluator
  (JNIEnv*, jclass, jint)
{
}
 ...
 */
JNIEXPORT jboolean JNICALL
Java_com_snobot_simulator_jni_module_1wrapper_RelayWrapperJni_getFowardValue
  (JNIEnv*, jclass, jint portHandle)
{
 ...
 */
JNIEXPORT jboolean JNICALL
Java_com_snobot_simulator_jni_module_1wrapper_RelayWrapperJni_getReverseValue
  (JNIEnv*, jclass, jint portHandle)
{
...
Java_com_snobot_simulator_jni_module_1wrapper_RelayWrapperJni_getPortList
  (JNIEnv* env, jclass)
{
    const std::map<int, std::shared_ptr<IRelayWrapper>>& relays = SensorActuatorRegistry::Get().GetIRelayWrapperMap();

    jintArray output = env->NewIntArray(relays.size());

    jint values[30];

    std::map<int, std::shared_ptr<IRelayWrapper>>::const_iterator iter = relays.begin();
