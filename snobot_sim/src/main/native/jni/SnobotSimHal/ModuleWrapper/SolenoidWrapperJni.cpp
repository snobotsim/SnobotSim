...
extern "C" {
/*
 * Class:     com_snobot_simulator_jni_module_1wrapper_SolenoidWrapperJni
 * Method:    isInitialized
 * Signature: (I)Z
 */
JNIEXPORT jboolean JNICALL
Java_com_snobot_simulator_jni_module_1wrapper_SolenoidWrapperJni_isInitialized
...
Java_com_snobot_simulator_jni_module_1wrapper_SolenoidWrapperJni_setName
...
Java_com_snobot_simulator_jni_module_1wrapper_SolenoidWrapperJni_getName
 ...
 */
JNIEXPORT jboolean JNICALL
Java_com_snobot_simulator_jni_module_1wrapper_SolenoidWrapperJni_getWantsHidden
 ...
 */
JNIEXPORT jboolean JNICALL
Java_com_snobot_simulator_jni_module_1wrapper_SolenoidWrapperJni_createSimulator
 ...
 */
JNIEXPORT void JNICALL
Java_com_snobot_simulator_jni_module_1wrapper_SolenoidWrapperJni_removeSimluator
  (JNIEnv*, jclass, jint)
{
}
 ...
 */
JNIEXPORT jboolean JNICALL
Java_com_snobot_simulator_jni_module_1wrapper_SolenoidWrapperJni_get
  (JNIEnv*, jclass, jint portHandle)
{
...
Java_com_snobot_simulator_jni_module_1wrapper_SolenoidWrapperJni_getPortList
  (JNIEnv* env, jclass)
{
