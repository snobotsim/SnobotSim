...
public class TestEncoderJni extends BaseSimulatorJniTest
{
    ...
    {
        IEncoderWrapper wrapper = DataAccessorFactory.getInstance().getEncoderAccessor().createSimulator(0, "com.snobot.simulator.module_wrapper.wpi.WpiEncoderWrapper");
