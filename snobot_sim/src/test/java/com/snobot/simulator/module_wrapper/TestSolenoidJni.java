...
public class TestSolenoidJni extends BaseSimulatorJniTest
{
    ...
    {
        ISolenoidWrapper wrapper = DataAccessorFactory.getInstance().getSolenoidAccessor().createSimulator(3, "com.snobot.simulator.module_wrapper.wpi.WpiSolenoidWrapper");
