...
{
    private static final File PLUGIN_DIR = new File("user_libs");
    ...
    {
    	System.out.println("Searching for robot plugins in " + PLUGIN_DIR.getAbsolutePath());
        mDiscoveredJars = PLUGIN_DIR.listFiles(new FilenameFilter()
        {
