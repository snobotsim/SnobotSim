...
// DataAccessorFactory.getInstance().getSpeedControllerAccessor().getPortList().size());
//
...
//
// Assert.assertEquals(0,
// DataAccessorFactory.getInstance().getSpeedControllerAccessor().getVoltagePercentage(mRawHandle),
// DOUBLE_EPSILON);
//
// canTalon1.set(-1.0);
...
// DataAccessorFactory.getInstance().getSimulatorDataAccessor().createMotor("CIM",
// 1, 10, 1);
// Assert.assertTrue(DataAccessorFactory.getInstance().getSimulatorDataAccessor().setSpeedControllerModel_Static(mRawHandle,
// motorConfig,
...
// DataAccessorFactory.getInstance().getSpeedControllerAccessor().getPosition(mRawHandle),
// .05);
...
// DataAccessorFactory.getInstance().getSpeedControllerAccessor().getVelocity(mRawHandle),
// .05);
//
//
// System.out.println(talon.getEncPosition());
