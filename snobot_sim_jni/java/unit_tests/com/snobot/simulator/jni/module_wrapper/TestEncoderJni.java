...
public class TestEncoderJni extends BaseSimulatorTest
{
    ...
    // DataAccessorFactory.getInstance().getEncoderAccessor().getHookedUpId(0));
    //
    ...
    // DataAccessorFactory.getInstance().getEncoderAccessor().getHookedUpId(0));
    //
    // Assert.assertTrue(DataAccessorFactory.getInstance().getEncoderAccessor().connectSpeedController(0,
    // 0));
    // Assert.assertTrue(
    // DataAccessorFactory.getInstance().getSimulatorDataAccessor().setSpeedControllerModel_Simple(0,
    // new SimpleMotorSimulationConfig(12)));
    ...
    // DOUBLE_EPSILON);
    // Assert.assertEquals(12.0 / 4,
    // DataAccessorFactory.getInstance().getEncoderAccessor().getRaw(0),
    // DOUBLE_EPSILON);
    // }
